...
type Args struct {
	Entity string         `json:"entity" jsonschema:"anime"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.YummyanimeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "yummyanime_list",
		Description: "List records from Yummyanime. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "yummyanime_load",
		Description: "Load a single record from Yummyanime. " +
...
func runOp(client *sdk.YummyanimeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.YummyanimeSDK, name string) (sdk.YummyanimeEntity, error) {
