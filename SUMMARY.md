...
Results: Successful search response containing anime results.
...
| --- | --- | --- | --- |
| Anime | `list` | `GET /search` | See reference |

## Connect to the API

- YummyAnime Platform: `https://yummyani.me`
...
- `yummyanime_list`: List records for an entity. Supported entities: `anime`.
- `yummyanime_load`: Load one record for an entity. No active entity supports this operation.
