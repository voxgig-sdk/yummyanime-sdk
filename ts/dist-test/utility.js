...
function envOverride(m) {
    if ('TRUE' === process.env.YUMMYANIME_TEST_LIVE ||
        'TRUE' === process.env.YUMMYANIME_TEST_OVERRIDE) {
    ...
    m.YUMMYANIME_TEST_EXPLAIN = process.env.YUMMYANIME_TEST_EXPLAIN || m.YUMMYANIME_TEST_EXPLAIN;
    return m;
}
