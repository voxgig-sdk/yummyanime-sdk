# Yummyanime TypeScript SDK



The TypeScript SDK for the Yummyanime API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Anime()` — each with a small set of operations (`list`)
...
- Releases: [https://github.com/voxgig-sdk/yummyanime-sdk/releases](https://github.com/voxgig-sdk/yummyanime-sdk/releases)
...
```ts
const animes = await client.Anime().list({ query: "example" })
...
| `tester(testopts?, sdkopts?)` | `YummyanimeSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `YummyanimeSDK.test(testopts?, sdkopts?)` | `YummyanimeSDK` | Create a test-mode client. |
...
| `client` | `client(): YummyanimeSDK` | Return the parent SDK client. |
...
yummyanime/
├── src/
│   ├── YummyanimeSDK.ts        # Main SDK class
