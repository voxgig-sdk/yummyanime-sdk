# Yummyanime SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions YummyanimeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both YummyanimeSDK(...) and YummyanimeSDK.test(...) become
#      YummyanimeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "yummyanime_sdk"
_SDK_CLASS = "YummyanimeSDK"
