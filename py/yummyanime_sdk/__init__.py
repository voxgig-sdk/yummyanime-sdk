...
from yummyanime_sdk.utility import register

# Load features
from yummyanime_sdk.feature.base_feature import YummyanimeBaseFeature
from yummyanime_sdk.features import _has_feature, _make_feature
...
class YummyanimeSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = YummyanimeUtility()
        self._utility = utility

        from yummyanime_sdk.config import shared_config
    ...
    def get_utility(self):
        return YummyanimeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("YummyanimeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Anime(self, data=None) -> "AnimeEntity":
        ...
        from yummyanime_sdk.entity.anime_entity import AnimeEntity
