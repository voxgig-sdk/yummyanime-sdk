# Yummyanime Python SDK Reference

Complete API reference for the Yummyanime Python SDK.
...
#### `YummyanimeSDK.test(testopts=None, sdkopts=None)`
...
```python
results = client.Anime().list({"query": "example"})
