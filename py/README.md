...
The Python SDK for the Yummyanime API — an entity-oriented client following Pythonic conventions.
...
## Install
```bash
pip install voxgig-sdk-yummyanime
```
...
```
py/
├── yummyanime_sdk.py         -- Main SDK module
