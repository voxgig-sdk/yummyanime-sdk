...
func registerSDKWords(r *eng.Registry, client *sdk.YummyanimeSDK) {
...
func runOp(client *sdk.YummyanimeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
