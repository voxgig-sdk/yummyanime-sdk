...
local YummyanimeSDK = {}
YummyanimeSDK.__index = YummyanimeSDK
...
YummyanimeSDK._make_feature = _make_feature


function YummyanimeSDK.new(options)
  local self = setmetatable({}, YummyanimeSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function YummyanimeSDK:options_map()
...
function YummyanimeSDK:get_utility()
  return Utility.copy(self._utility)
end


function YummyanimeSDK:get_root_ctx()
  return self._rootctx
end


function YummyanimeSDK:prepare(fetchargs)
...
function YummyanimeSDK:direct(fetchargs)
...
-- by passing it.
function YummyanimeSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function YummyanimeSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "YummyanimeSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function YummyanimeSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = YummyanimeSDK.new(sdkopts)
  sdk.mode = "test"
