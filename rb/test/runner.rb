...
module YummyanimeTestRunner
  ...
  def self.env_override(m)
    live = getenv("YUMMYANIME_TEST_LIVE")
    override = getenv("YUMMYANIME_TEST_OVERRIDE")
    ...
    explain = getenv("YUMMYANIME_TEST_EXPLAIN")
    m["YUMMYANIME_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = YummyanimeTestRunner
Helpers = YummyanimeHelpers
Vs = VoxgigStruct
