...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/yummyanime` | `npm install @voxgig-sdk/yummyanime` |
| Python | `voxgig-sdk-yummyanime` | `pip install voxgig-sdk-yummyanime` |
| PHP | `voxgig-sdk/yummyanime` | `composer require voxgig-sdk/yummyanime` |
| Golang | `github.com/voxgig-sdk/yummyanime-sdk/go` | `go get github.com/voxgig-sdk/yummyanime-sdk/go` |
| Ruby | `voxgig-sdk-yummyanime` | `gem install voxgig-sdk-yummyanime` |
| Lua | `voxgig-sdk-yummyanime` | `luarocks install voxgig-sdk-yummyanime` |
