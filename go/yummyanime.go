...
// instead of `sdk.NewYummyanimeSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *YummyanimeSDK  { return NewYummyanimeSDK(nil) }
func Test() *YummyanimeSDK { return TestSDK(nil, nil) }
