...
func (sdk *YummyanimeSDK) OptionsMap() map[string]any {
...
func (sdk *YummyanimeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *YummyanimeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *YummyanimeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YummyanimeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *YummyanimeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *YummyanimeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("YummyanimeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *YummyanimeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YummyanimeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("YummyanimeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
