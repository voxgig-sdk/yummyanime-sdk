...
The Golang SDK for the Yummyanime API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/yummyanime-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/yummyanime-sdk=../path/to/github.com/voxgig-sdk/yummyanime-sdk
```
...
```
github.com/voxgig-sdk/yummyanime-sdk/
...
The root package (`github.com/voxgig-sdk/yummyanime-sdk`) re-exports everything needed
