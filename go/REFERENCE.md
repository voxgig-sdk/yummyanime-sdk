# Yummyanime Golang SDK Reference

Complete API reference for the Yummyanime Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *YummyanimeSDK`
...
#### `Anime(data map[string]any) YummyanimeEntity`
