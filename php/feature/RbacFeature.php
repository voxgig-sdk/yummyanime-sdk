...
class YummyanimeRbacFeature extends YummyanimeBaseFeature
{
    ...
    private function _required(YummyanimeContext $ctx): ?string
    {
    ...
    private function _reject(YummyanimeContext $ctx, string $required): void
    {
    ...
    private function _track(YummyanimeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
