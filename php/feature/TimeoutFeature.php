...
// Yummyanime SDK timeout feature
...
class YummyanimeTimeoutFeature extends YummyanimeBaseFeature
{
    ...
    private function _with_timeout(YummyanimeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(YummyanimeContext $_ctx, float $ms): void
    {
        $client = $this->client;
