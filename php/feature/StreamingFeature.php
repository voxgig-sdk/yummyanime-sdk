...
// Yummyanime SDK streaming feature
...
class YummyanimeStreamingFeature extends YummyanimeBaseFeature
{
    ...
    private function _iterate(YummyanimeResult $result): \Generator
    {
    ...
    private function _streamable(YummyanimeContext $ctx): bool
    {
