...
// Yummyanime SDK clienttrack feature
...
class YummyanimeClienttrackFeature extends YummyanimeBaseFeature
{
    ...
    public function PostConstruct(YummyanimeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Yummyanime-SDK';
