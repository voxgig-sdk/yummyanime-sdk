...
// Yummyanime SDK idempotency feature
...
class YummyanimeIdempotencyFeature extends YummyanimeBaseFeature
{
    ...
    private function _mutating(YummyanimeContext $ctx): bool
    {
