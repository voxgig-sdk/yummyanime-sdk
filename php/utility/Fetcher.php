...
// Yummyanime SDK utility: fetcher

class YummyanimeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; YummyanimeSDK/1.0)';
    ...
    public static function call(YummyanimeContext $ctx, string $fullurl, array $fetchdef): array
    {
