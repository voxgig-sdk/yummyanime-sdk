...
class YummyanimeTestRunner
{
    ...
    {
        $live = self::getenv('YUMMYANIME_TEST_LIVE');
        $override = self::getenv('YUMMYANIME_TEST_OVERRIDE');
        ...
        $explain = self::getenv('YUMMYANIME_TEST_EXPLAIN');
...
class_alias('YummyanimeTestRunner', 'Runner');
class_alias('YummyanimeHelpers', 'Helpers');
