...
// Yummyanime SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (YummyanimeSDK::test)
...
{
    private const SDK_CLASS = 'YummyanimeSDK';
    ...
    private const SDK_BASE = 'yummyanime_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../yummyanime_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
