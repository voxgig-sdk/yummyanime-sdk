...
from projectname_sdk.core.control import YummyanimeControl
...
class YummyanimeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, YummyanimeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, YummyanimeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, YummyanimeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return YummyanimeError(code, msg, self)
