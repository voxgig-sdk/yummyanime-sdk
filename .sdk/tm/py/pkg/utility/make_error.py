...
def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import YummyanimeContext
        ctx = YummyanimeContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, YummyanimeError):
        errmsg = err.msg
    ...
    sdk_err = YummyanimeError("", msg, ctx)
