...
class YummyanimeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YummyanimeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = YummyanimeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = YummyanimeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
