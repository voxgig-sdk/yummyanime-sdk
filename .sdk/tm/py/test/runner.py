...
class YummyanimeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YummyanimeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = YummyanimeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = YummyanimeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
