...
from projectname_sdk import YummyanimeSDK
from projectname_sdk.core.spec import YummyanimeSpec
from projectname_sdk.core.result import YummyanimeResult
from projectname_sdk.core.response import YummyanimeResponse
from projectname_sdk.core.operation import YummyanimeOperation
from projectname_sdk.core.error import YummyanimeError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import YummyanimeBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return YummyanimeError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = YummyanimeSDK.test(None, None)
        ...
        class TestInitFeature(YummyanimeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(YummyanimeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = YummyanimeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = YummyanimeSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = YummyanimeSDK.test(None, setup_opts)
