...
// Yummyanime SDK utility: graphql
//
...
class YummyanimeGraphql
{
    ...
    // equivalent.
    public static function body(YummyanimeContext $ctx): mixed
    {
    ...
    public static function errors(YummyanimeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
