...
// Yummyanime SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = YummyanimeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(YummyanimeOmni::structfix($now, Struct::undef()))
                        !== json_encode(YummyanimeOmni::structfix($val, Struct::undef()))) {
