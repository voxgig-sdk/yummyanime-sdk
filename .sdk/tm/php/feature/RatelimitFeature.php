...
// Yummyanime SDK ratelimit feature
...
class YummyanimeRatelimitFeature extends YummyanimeBaseFeature
{
    ...
    private function _acquire(YummyanimeContext $ctx): void
    {
    ...
    private function _track(YummyanimeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
