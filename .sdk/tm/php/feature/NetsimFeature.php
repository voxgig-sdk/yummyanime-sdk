...
class YummyanimeNetsimFeature extends YummyanimeBaseFeature
{
    ...
    private function _simulate(YummyanimeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(YummyanimeContext $ctx, array $applied): void
    {
        $client = $this->client;
