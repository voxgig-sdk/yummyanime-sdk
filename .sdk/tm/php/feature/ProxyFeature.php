...
class YummyanimeProxyFeature extends YummyanimeBaseFeature
{
    ...
    public function init(YummyanimeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YummyanimeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
