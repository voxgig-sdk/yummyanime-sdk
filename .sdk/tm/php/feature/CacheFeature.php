...
class YummyanimeCacheFeature extends YummyanimeBaseFeature
{
    ...
    private function _through(YummyanimeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
