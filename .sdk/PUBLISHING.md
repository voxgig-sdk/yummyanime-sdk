...
|---|---|---|
| `ts/` | @voxgig-sdk/yummyanime-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/yummyanime-sdk \
      --repository voxgig-sdk/yummyanime-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/yummyanime-sdk` shows it, and
`npm trust revoke @voxgig-sdk/yummyanime-sdk --id=<id>` removes it.
